...
q-card.shadow-24
    q-card-section
        q-table(:rows="asesorias" :columns="columns" :pagination="pagination" v-if="!loading").shadow-0
            template(v-slot:top)
        ...
        q-dialog(v-model="dialog")
            q-card
                q-card-section: .text-center.text-caption.text-grey Se muestran los contenidos registrados hasta el el momento. Los reportes de desempeño aprobados por el director se encuentran en la sección de #[strong reportes].
                q-card-section
