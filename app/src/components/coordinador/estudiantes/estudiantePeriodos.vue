                    ...
                    q-card.shadow-24
                        ...
                        q-card-section.text-center
                            ...
                            div(v-if="i.activeDates").q-mt-md
                                q-input(label="1er Coloquio" type="date" v-model="i.coloquio1" standout="bg-primary text-white" stack-label dense).q-mt-sm
                                q-input(label="2do Coloquio" type="date" v-model="i.coloquio2" standout="bg-primary text-white" stack-label dense).q-mt-sm
                                q-input(label="Examen de candidatura" type="date" v-model="i.candidatura" standout="bg-primary text-white" stack-label dense).q-mt-sm
                                q-input(label="Examen de grado" type="date" v-model="i.grado" standout="bg-primary text-white" stack-label dense).q-mt-sm
